 ...
 */
#ifndef CORSAC_CHRONO_H
#define CORSAC_CHRONO_H
...
namespace corsac
{
        ...
        namespace internal
        {
            ...
            inline uint64_t GetTicks()
            {
                    ...
                    auto queryFrequency = []
                    {
                        ...
                        return double(1000000000.0L / frequency.QuadPart);  // наносекунды за тик
                    };
    ...
    // chrono_literals
    #if CORSAC_USER_LITERALS_ENABLED
    ...
    namespace chrono
    {
        using namespace corsac::literals::chrono_literals;
    } // namespace chrono
#endif

#endif //CORSAC_CHRONO_H
