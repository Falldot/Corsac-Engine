 ...
 */
#ifndef CORSAC_NUMERIC_LIMITS_H
...
#define CORSAC_LIMITS_DIGITS_S(T) ((sizeof(T) * CHAR_BIT) - 1)
#define CORSAC_LIMITS_DIGITS_U(T) ((sizeof(T) * CHAR_BIT))
...
#if CORSAC_CHAR16_NATIVE // Если char16_t является истинным уникальным типом (как того требует стандарт C++ 11) ...
...
#if CORSAC_CHAR32_NATIVE // Если char32_t - истинный уникальный тип (как того требует стандарт C++ 11) ...
