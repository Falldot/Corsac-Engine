...
*// TODO: Заменить std::move на кастомный (см. corsac::move)
*{
//        Swap(value);
*}
//
...
//        // value_point pNewEnd = corsac::uninitialized_move_ptr_if_noexcept(mpBegin, mpEnd, pNewData);
...
//        // TODO: Заменить std::swap на кастомный (см. corsac::swap)
*}
//
*template<typename T, typename Allocator>
