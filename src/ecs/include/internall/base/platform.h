//
// internal/base/platform.h
//
// Created by Falldot on 01.11.2021.
// Copyright (c) 2021 Corsac. All rights reserved.
//

#ifndef CORSAC_PLATFORM_H
#define CORSAC_PLATFORM_H
...
//// CORSAC_PLATFORM_WORD_SIZE
//‎//‎‎ Это определяет размер машинного слова. Это будет то же самое, что и‎
//‎//‎‎ размер регистров на машине, но не обязательно одинаковый‎
//‎//‎‎ как размер указателей на машине. Ряд 64-битных платформ‎
//‎//‎‎ имеют 64-битные регистры, но 32-битные указатели.‎
////
#ifndef CORSAC_PLATFORM_WORD_SIZE
    #define CORSAC_PLATFORM_WORD_SIZE CORSAC_PLATFORM_PTR_SIZE
#endif
...
#ifndef CORSAC_MISALIGNED_SUPPORT_LEVEL
    #if defined(CORSAC_PROCESSOR_X86_64)
        #define CORSAC_MISALIGNED_SUPPORT_LEVEL 2
    #else
        #define CORSAC_MISALIGNED_SUPPORT_LEVEL 0
    #endif
#endif

// Macro to determine if a Windows API partition is enabled. Always false on non Microsoft platforms.
#if !defined(CORSAC_WINAPI_FAMILY_PARTITION)
    #define CORSAC_WINAPI_FAMILY_PARTITION(Partition) (0)
#endif


#ifndef CORSAC_CACHE_LINE_SIZE
    #if   defined(CORSAC_PROCESSOR_X86)
        #define CORSAC_CACHE_LINE_SIZE 32    // This is the minimum possible value.
    #elif defined(CORSAC_PROCESSOR_X86_64)
        #define CORSAC_CACHE_LINE_SIZE 64    // This is the minimum possible value
    #elif defined(CORSAC_PROCESSOR_ARM32)
        #define CORSAC_CACHE_LINE_SIZE 32    // This varies between implementations and is usually 32 or 64.
    #elif defined(CORSAC_PROCESSOR_ARM64)
        #define CORSAC_CACHE_LINE_SIZE 64    // Cache line Cortex-A8  (64 bytes) http://shervinemami.info/armAssembly.html however this remains to be mostly an assumption at this stage
    #elif (CORSAC_PLATFORM_WORD_SIZE == 4)
        #define CORSAC_CACHE_LINE_SIZE 32    // This is the minimum possible value
    #else
        #define CORSAC_CACHE_LINE_SIZE 64    // This is the minimum possible value
    #endif
