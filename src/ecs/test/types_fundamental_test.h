...
bool types_fundamental_test(CorsacTest* assert)
{
    ...
    assert->add_block("is_null_pointer", [](CorsacTest* assert)
    {
    ...
    assert->add_block("is_arithmetic", [](CorsacTest* assert)
    {
    ...
    assert->add_block("is_fundamental", [](CorsacTest* assert)
    {
        class T{};
    ...
    assert->add_block("is_hat_type", [](CorsacTest* assert)
    {
        class T{};
