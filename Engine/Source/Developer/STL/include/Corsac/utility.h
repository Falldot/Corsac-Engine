 ...
 */
#ifndef CORSAC_STL_UTILITY_H
#define CORSAC_STL_UTILITY_H
 ...
 *      index_sequence_for          Шаблон преобразования любого пакета параметров типа в последовательность индекса той же длины.
 *      make_index_sequence         Шаблон упрощения создания corsac::index_sequence типа.
 *      make_integer_sequence       Шаблон упрощения создания corsac::integer_sequence типа.
 *
 * === Функции:
 *
